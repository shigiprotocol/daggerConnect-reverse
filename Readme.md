...
**ریورس تانل قدرتمند با قابلیت Traffic Obfuscation**
...
8. پورت Bind را وارد کنید (پورتی که کاربر به آن متصل میشود)
9. آدرس Target را وارد کنید (پیش‌فرض: 127.0.0.1)
10. پورت Target را وارد کنید (پورت سرویس شما)
11. در صورت نیاز، mapping های دیگر اضافه کنید
```
